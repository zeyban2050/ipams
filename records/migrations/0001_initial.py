    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year_completed', models.CharField(blank=True, default='', max_length=30)),
                ('abstract', ckeditor.fields.RichTextField()),
                ('abstract_filename', models.CharField(blank=True, default='', max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issn', models.CharField(blank=True, default='', max_length=50)),
                ('isi', models.CharField(blank=True, default='', max_length=50)),
                ('year_published', models.CharField(blank=True, default='', max_length=50)),
